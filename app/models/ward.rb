class Ward < ApplicationRecord
  ...
  validates :one_ldk_avg_rent, presence: true, numericality: true, numericality: { only_integer: true, greater_than: 0}
  validates :two_ldk_avg_rent, presence: true, numericality: true, numericality: { only_integer: true, greater_than: 0}
  validates :three_ldk_avg_rent, presence: true, numericality: true, numericality: { only_integer: true, greater_than: 0}

  validates :safety, presence: true, allow_blank: false, numericality: { greater_than_or_equal_to: 0.0, less_than_or_equal_to: 1.0}
